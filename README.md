...
Uploading them publicly = copyright violation

→ Even if it’s just a little

→ Even if you “combine” it with your own notes

→ Even if you put MIT license on the repo

→ Even if you credit the professor
...
If your LaTeX notes quote or reproduce professor text (e.g., copy–paste homework questions or slide text), that part is not yours.
...
Your own notes (paraphrased, original text)

Your own diagrams

Your own LaTeX explanations

Your own code or solutions

No direct copy of slides, homework, or test problems.

If you want to discuss problems, rewrite them fully in your own way.
